...
|---|---|---|---|---|
| `replay-hero-desktop.jpg` | リプレイ再生中（複数艇＋航跡） | デスクトップ1440x900・6艇・t=00:54:34（艇団がタックでばらけた瞬間） | **ホームのヒーロー画像（最重要）** | 複数艇を同時再生し、色分け＋常時ラベルで識別できていること（UI-DESIGN §4.2） |
...
- [x] 素材はすべて `frontend/public/screenshots/` に整理済み・合計約380KB
